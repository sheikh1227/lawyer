  ...
  <div class="navbar-header d-xl-block d-none">
    <ul class="nav navbar-nav">
      <li class="nav-item">
        ...
        <h2 class="brand-text mb-0">Lawyer</h2>
        </a>
      </li>
    </ul>
  </div>
  ...
  <nav class="header-navbar navbar navbar-expand-lg align-items-center {{ $configData['navbarClass'] }} navbar-light navbar-shadow {{ $configData['navbarColor'] }}">
    ...
    <div class="navbar-container d-flex content">
        ...
        <ul class="nav navbar-nav align-items-center ml-auto">
          ...
          <li class="nav-item dropdown dropdown-cart mr-25"><a class="nav-link" href="javascript:void(0);" data-toggle="dropdown"><i class="ficon" data-feather="mail"></i><span class="badge badge-pill badge-primary badge-up cart-item-count">6</span></a>
            <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                ...
                <div class="media align-items-center">
                  <div class="media-body">
                    <div class="media-heading">
                      <h6 class="cart-item-title"><a class="text-body" href="{{url('app/ecommerce/details')}}"> Subject </a></h6><small class="cart-item-by">Davd Melendez</small>
                    </div>
					  <div class="media-heading">
                      <small class="cart-item-by">20.08.2021  16:00</small>
                    </div>
              ...
              <li class="dropdown-menu-footer">
                ...
                </div><a class="btn btn-primary btn-block" href="{{url('app/ecommerce/checkout')}}">All</a>
              </li>
            </ul>
          </li>
        ...
        <li class="nav-item dropdown dropdown-user">
          <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <div class="user-nav d-sm-flex d-none">
              ...
              <span class="user-status">{{Auth::user()->have_role->RoleName}}</span>
            </div>
            <span class="avatar">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user">
            ...
            <a class="dropdown-item"  style="position: relative;">
                ...
                <form method="post" action="{{url('/logout')}}" >
                    {{csrf_field()}}
                  <input type="submit" class="dropdown-item" value="Logout" style="    position: absolute; top: 0; left: 27px;"> 
                </form>
            </a>
