        ...
        <li class="list-inline-item">
          <div class="dropdown no-arrow">
            ...
            <div class="dropdown-menu" aria-labelledby="tag">
              ...
              <a href="javascript:void(0);" class="dropdown-item"
                ><span class="mr-50 bullet bullet-primary bullet-sm"></span>Readed</a
              >
              <a href="javascript:void(0);" class="dropdown-item"
                ><span class="mr-50 bullet bullet-warning bullet-sm"></span>Not Resolved</a
              >
              
              <a href="javascript:void(0);" class="dropdown-item"
                ><span class="mr-50 bullet bullet-success bullet-sm"></span>Resolved</a
              >
            </div>
          </div>
        </li>
