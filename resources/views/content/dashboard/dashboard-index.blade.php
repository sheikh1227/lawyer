            ...
            <div class="calendar-events-filter">
              <div class="custom-control custom-control-danger custom-checkbox mb-1">
                <input
                  ...
                  checked
                />
                <label class="custom-control-label" for="personal">Court Date</label>
              </div>
              <div class="custom-control custom-control-primary custom-checkbox mb-1">
                <input
                  ...
                  checked
                />
                <label class="custom-control-label" for="business">Client Appointment</label>
              </div>
              <div class="custom-control custom-control-warning custom-checkbox mb-1">
                <input
                  ...
                  checked
                />
                <label class="custom-control-label" for="family">Vacation</label>
              </div>
        ...
        <div class="modal-body flex-grow-1 pb-sm-0 pb-3">
          <form class="event-form needs-validation" data-ajax="false" novalidate>
            ...
            <div class="form-group">
              ...
              <select class="select2 select-label form-control w-100" id="select-label" name="business">
            ...
            <div class="form-group position-relative">
              ...
              <input type="text" class="form-control" id="start-date" name="startdate" placeholder="Start Date" />
            </div>
            <div class="form-group position-relative">
              <label for="end-date" class="form-label">End Date</label>
              <input type="text" class="form-control" id="end-date" name="enddate" placeholder="End Date" />
            </div>
            <div class="form-group">
              <div class="custom-control custom-switch">
                <input type="checkbox" name="allday" class="custom-control-input allDay-switch" id="customSwitch3" />
            ...
            <div class="form-group select2-primary">
              ...
              <select name="guest" class="select2 select-add-guests form-control w-100" id="event-guests" multiple>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="location" id="event-location" placeholder="Enter Location" />
            </div>
            <div class="form-group">
