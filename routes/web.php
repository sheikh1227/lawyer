...
Route::get('/', [DashboardController::class,'dashboardAnalytics'])->name('dashboard-index');

Auth::routes(['verify' => false]);

/* Route Dashboards */
Route::group(['prefix' => 'dashboard'], function () {
  Route::get('analytics', [DashboardController::class,'dashboardAnalytics'])->name('dashboard-index');
  
});
/* Route Dashboards */

/* Route Apps */
// Route::group(['prefix' => 'admin',  'middleware' => ['auth', 'verified','auth', 'roles'], 'roles' => ['Admin', 'manager'] ], function()
// {
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'roles'], 'roles' => ['Admin', 'manager'] ], function () {

  Route::get('/', [DashboardController::class,'dashboardAnalytics'])->name('dashboard-index');
  Route::get('email', [AppsController::class,'emailApp'])->name('admin-email');
  Route::get('chat', [AppsController::class,'chatApp'])->name('admin-chat');
	Route::get('cases', [AppsController::class,'casesApp'])->name('admin-cases');
  Route::get('todo', [AppsController::class,'todoApp'])->name('admin-todo');
  Route::get('calendar', [AppsController::class,'calendarApp'])->name('admin-calendar');
  Route::get('kanban', [AppsController::class,'kanbanApp'])->name('admin-kanban');
  Route::get('invoice/list', [AppsController::class,'invoice_list'])->name('admin-invoice-list');
  Route::get('invoice/preview', [AppsController::class,'invoice_preview'])->name('admin-invoice-preview');
  Route::get('invoice/edit', [AppsController::class,'invoice_edit'])->name('admin-invoice-edit');
  Route::get('invoice/add', [AppsController::class,'invoice_add'])->name('admin-invoice-add');
  Route::get('invoice/print', [AppsController::class,'invoice_print'])->name('admin-invoice-print');
  Route::get('ecommerce/shop', [AppsController::class,'ecommerce_shop'])->name('admin-ecommerce-shop');
  Route::get('ecommerce/details', [AppsController::class,'ecommerce_details'])->name('admin-ecommerce-details');
  Route::get('ecommerce/wishlist', [AppsController::class,'ecommerce_wishlist'])->name('admin-ecommerce-wishlist');
  Route::get('ecommerce/checkout', [AppsController::class,'ecommerce_checkout'])->name('admin-ecommerce-checkout');
  Route::get('file-manager', [AppsController::class,'file_manager'])->name('admin-file-manager');
  Route::get('user/list', [AppsController::class,'user_list'])->name('admin-user-list');
  Route::get('user/view/{id}', [AppsController::class,'user_view'])->name('admin-user-view');
  Route::get('user/edit/{id}', [AppsController::class,'user_edit'])->name('admin-user-edit');
  Route::get('contact', [AppsController::class,'contact_list'])->name('admin-contact');
  Route::get('get_contact_list', [AppsController::class,'get_contact_list'])->name('admin-get_contact_list');
  Route::get('contact/view/{id}', [AppsController::class,'contact_view'])->name('admin-contact-view');
  Route::post('contact/addnotes/{id}', [AppsController::class,'contact_add_notes'])->name('admin-contact-notes-save');
  Route::delete('contact/delete/{id}', [AppsController::class,'contact_delete'])->name('admin-contact-delete');
  Route::post('create-case/{id}', [AppsController::class,'contact_conver_into_case'])->name('admin-conver-into-case');
  Route::post('update-case/{id}', [AppsController::class,'update_case'])->name('admin-update-case');
  Route::get('case/{id}', [AppsController::class,'constant_case'])->name('admin-contact-case');
  Route::get('get_users', [AppsController::class,'get_users'])->name('get_users');
  Route::post('add_user', [AppsController::class,'add_user'])->name('add_user');
  
  Route::get('case/close/{id}', [AppsController::class,'close_case'])->name('close_case');
  Route::get('case/delete/{id}', [AppsController::class,'delete_case'])->name('delete_case');
  Route::POST('case/send/email/{id}', [AppsController::class,'case_send_email'])->name('case_send_email');
  Route::POST('case/add/record/{id}', [AppsController::class,'case_add_record'])->name('case_add_record');
  Route::get('case/share/{id}', [AppsController::class,'case_share'])->name('case_share');

  Route::get('profile/view', [AppsController::class,'profile_view'])->name('admin-profile-view');
  Route::get('profile/edit', [AppsController::class,'profile_edit'])->name('admin-profile-edit');

  Route::post('site/setting',[SiteSettingsController::class,'navbarSetting'])->name('admin-setting-navbar');
...
Route::group(['prefix' => 'customer', 'middleware' => ['auth', 'roles'], 'roles' => ['Customer', 'manager'] ], function () {
  ...
  Route::get('/', [DashboardController::class,'dashboardAnalytics'])->name('dashboard-index');
  Route::get('profile/view', [AppsController::class,'profile_view'])->name('customer-profile-view');
  Route::get('profile/edit', [AppsController::class,'profile_edit'])->name('customer-profile-edit');
...
Route::group(['prefix' => 'lawyer', 'middleware' => ['auth', 'roles'], 'roles' => ['Lawyer', 'manager'] ], function () {
...
Route::group(['prefix' => 'partner', 'middleware' => ['auth', 'roles'], 'roles' => ['Partner', 'manager'] ], function () {
  
  Route::get('/', [DashboardController::class,'dashboardAnalytics'])->name('dashboard-index');
  Route::get('profile/view', [AppsController::class,'profile_view'])->name('partner-profile-view');
  Route::get('profile/edit', [AppsController::class,'profile_edit'])->name('partner-profile-edit');
  Route::get('cases', [AppsController::class,'casesApp'])->name('partner-cases');
...
Route::group(['middleware' => ['auth']], function () {
  ...
  Route::post('update_user/{id}', [AppsController::class,'update_user'])->name('update_user');
  Route::get('get_user_case/{id}', [AppsController::class,'get_user_case'])->name('get_user_case');
